...
void dzg::createGraphicsPipeline() {


    auto vertShaderCode = readFile("../resources/shaders/TriangleShadervert.spv");
    auto fragShaderCode = readFile("../resources/shaders/TriangleShaderfrag.spv");
    ...
    //Scenario where blending is enabled
    ...
    if (vkCreateGraphicsPipelines(core.device, VK_NULL_HANDLE, 1, &pipelineInfo, nullptr, &graphicsPipeline) != VK_SUCCESS) {
