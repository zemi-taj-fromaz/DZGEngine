...
void dzg::updateUniformBuffer(uint32_t currentImage) {
 ...
 //   ubo.model = glm::rotate(glm::mat4(1.0f), time * glm::radians(90.0f), glm::vec3(0.0f, 0.0f, 1.0f));
    ...
    ubo.view = glm::mat4(1.0f);// glm::lookAt(glm::vec3(0.0f, 0.0f, .0f), glm::vec3(0.0f, 0.0f, 0.0f), glm::vec3(0.0f, 1.0f, 0.0f));

   // ubo.proj = glm::perspective(glm::radians(45.0f), core.swapChainExtent.width / (float)core.swapChainExtent.height, 0.1f, 10.0f);

    ubo.proj = glm::ortho(0.0f, 800.0f, 0.0f, 600.0f, -10.0f, 10.0f);
   // ubo.proj[1][1] *= -1;
